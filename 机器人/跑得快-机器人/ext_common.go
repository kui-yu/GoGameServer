...
func FindType(handcards1 []byte, outcards LastOutCards) ([][]byte, [][]byte) {
	...
	if outcards.Max != 0 {
		...
		result = append(result, FindCardsSunzi(5, handcards)...)
		result = append(result, FindCardsSunzi(6, handcards)...)
		result = append(result, FindCardsSunzi(7, handcards)...)
		result = append(result, FindCardsSunzi(8, handcards)...)
		result = append(result, FindCardsFeiJi(2, handcards)...)
		result = append(result, FindCardsFeiJi(3, handcards)...)
	}
	return boom, result
}
