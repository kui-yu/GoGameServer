...
func (this *ExtRobotClient) Start() {
	...
	this.CallTime = GExtConfig.CallTime
	if this.CallTime == 0 {
		this.CallTime = 3
	}
...
func (this *ExtRobotClient) AddHandler() {
	...
	this.Handle[MSG_GAME_INFO_BANKER_REPLY] = this.HandlerBanker
	this.Handle[MSG_GAME_INFO_SETTLE_INFO_END_REPLY] = this.HandlerSettle
	this.Handle[MSG_GAME_INFO_CALL_LIST] = this.HandlerCallList
}
