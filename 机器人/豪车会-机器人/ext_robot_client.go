...
func (this *ExtRobotClient) AddHandler() {
	...
	//豪车会
	this.Handle[MSG_GAME_INFO_RDESKINFO] = this.HandleDeskReply
	//处理状态改变通知，在结算阶段 改变自己的金币，在下注阶段，随机下注
	this.Handle[MSG_GAME_INFO_NSTATUS_CHANGE] = this.HandleStatusChange
	this.Handle[MSG_GAME_INFO_RDOWNBET] = this.HandleDownBetReplay
}
