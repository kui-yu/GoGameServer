...
func (this *ExtRobotClient) AddHandler() {
	...
	//百人经典牛牛定义
	//处理桌子信息
	this.Handle[MSG_GAME_INFO_QDESKINFO_REPLY] = this.HandleDeskReply
	//处理状态改变通知，在结算阶段 改变自己的金币，在下注阶段，随机下注
	this.Handle[MSG_GAME_INFO_STATUSCHANGE] = this.HandleStatusChange
	this.Handle[MSG_GAME_INFO_DOWNBET_REPLAY] = this.HandleDownBetReplay
	this.Handle[MSG_GAME_INFO_TOROBOTRESULT] = this.HandleToRobot
}
