...
func (this *Hall) Login(msg *InMsg) {
	...
	msg.Col.AddMsgNative(MSG_HALL_LOGIN_REPLY, &HMsgHallLoginReply{
		...
		CurrentRechargeAmount: player.CurrentRechargeAmount,
		NextRechargeAmount:    player.NextRechargeAmount,
		NextVipId:             player.NextVipId,
		NextVipName:           player.NextVipName,
	}, false)
}
