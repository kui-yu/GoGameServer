...
func (this *MgrCard) Shuffle() {
	// this.MSendId = 0
	// vd := []byte{}
	// vd = append(vd, Card_Hei_Q, Card_Hong_Q, Card_Mei_Q, Card_Fang_Q, Card_Mei_J, Card_Fang_J, Card_Hong_10)
	// vd = append(vd, Card_Fang_10, Card_Hei_10, Card_Hei_1, Card_Fang_1, Card_Hong_9, Card_Fang_9, Card_Mei_8)
	// vd = append(vd, Card_Hei_7, Card_Hong_7, Card_Mei_7, Card_Fang_7, Card_Fang_8, Card_Hei_3)

	// vd = append(vd, Card_Hei_Q, Card_Hong_Q, Card_Mei_Q, Card_Hong_J, Card_Mei_J, Card_Fang_J, Card_Hei_J)
	// vd = append(vd, Card_Fang_10, Card_Hei_10, Card_Hei_1, Card_Fang_1, Card_Hong_9, Card_Fang_9, Card_Mei_8)
	// vd = append(vd, Card_Hei_7, Card_Fang_8, Card_Hei_3)

	// vd = append(vd, Card_Hei_Q, Card_Hong_Q, Card_Mei_Q, Card_Hong_J, Card_Mei_J, Card_Fang_J, Card_Hong_10)
	// vd = append(vd, Card_Fang_10, Card_Hei_10, Card_King_1, Card_King_2, Card_Hong_9, Card_Fang_9, Card_Mei_8)
	// vd = append(vd, Card_Hei_7, Card_Fang_8, Card_Hei_3)

	// vd = append(vd, Card_Hei_K, Card_Hong_K, Card_Fang_K)
	// this.MVSourceCard = []byte{}
