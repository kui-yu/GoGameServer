...
const (
	...
	MSG_GAME_INFO_SEND_NOTIFY
	MSG_GAME_INFO_CALL
	MSG_GAME_INFO_CALL_REPLY
	MSG_GAME_INFO_BANKER_NOTIFY
	MSG_GAME_INFO_OUTCARD
	MSG_GAME_INFO_OUTCARD_REPLY
	MSG_GAME_INFO_PASS
	MSG_GAME_INFO_PASS_REPLY
	MSG_GAME_INFO_ROOM_NOTIFY
	MSG_GAME_INFO_TUOGUAN //410010
	MSG_GAME_INFO_TUOGUAN_REPLY
	MSG_GAME_INFO_AUTO_REPLY //410012,游戏随机匹配成功的数据
	MSG_GAME_INFO_RECONNECT_REPLY
	MSG_GAME_INFO_END_NOTIFY   //410014
